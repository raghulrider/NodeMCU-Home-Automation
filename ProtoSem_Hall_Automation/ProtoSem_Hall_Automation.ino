...
void handleLogin() {
  ...
  content += " COntact me: <a href='https://www.linkedin.com/in/raghul-prasad-v'>LinkedIn</a></body></html>";
...
void handleRoot() {
  ...
  String content = "<head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">";
  ...
  content += ".button { background-color: #f15b40; border: none; color: white; padding: 12px 24px;";
  content += "text-decoration: none; font-size: 20px; margin: 2px; cursor: pointer;}";
  content += ".button2 {background-color: #f9a980;border: none; color: white; padding: 12px 24px;text-decoration: none; font-size: 20px; margin: 2px; cursor: pointer;}</style></head>";
  ...
  content += "<p style ='color:#c74a1b'><marquee direction='right'>Vera level Protosem <strong>@FORGE</strong></marquee></p>";
